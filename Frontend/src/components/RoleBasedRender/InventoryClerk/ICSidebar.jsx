        ...
        <Offcanvas.Body className="sidebar-body">
          ...
          <Box height={"80%"}>
            <SidebarBtn
              icon={faPager}
              text="Dashboard"
              onClick={() => handleNavigate("/IC-dashboard")}
            />
            <SidebarBtn
              icon={faList}
              text={"Inventory"}
            ...
            {isVisibleinv && (
              <div className="button-group">
                <SidebarBtn
                  ...
                  onClick={() => handleNavigate("/IC-inventoryListofmedicine")}
                />
                <SidebarBtn
                  text={"Medicine Categories"}
                  onClick={() => handleNavigate("/IC-medicineGroups")}
                />
              </div>
            )}
